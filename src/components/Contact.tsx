              ...
              <div className="space-y-4">
                {contactInfo.map((info, index) => {
                  ...
                  return (
                    <Card 
                      key={index} 
                      className="card-gradient p-4 border border-primary/20 hover:border-primary/40 transition-all duration-300 hover:shadow-glow-primary hover:scale-105 hover:z-10 relative"
                    >
                      <a 
                        href={info.href}
